package com.whileiremember.config;
...
@Configuration
@ComponentScan(basePackages = { "com.whileiremember"})
@EnableWebMvc
@EnableTransactionManagement
@EnableJpaRepositories(basePackages = {"com.whileiremember.repository"})
public class AppConfig extends WebMvcConfigurerAdapter {
	...
	public DriverManagerDataSource dataSource() {
	    ...
	    driverManagerDataSource.setUrl("jdbc:mysql://localhost:3306/whileiremember");
